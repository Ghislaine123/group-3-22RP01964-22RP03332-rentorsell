    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="max-w-2xl mx-auto">
                <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit House Listing</h1>
                ...
                <form action="{{ route('houses.update', $house) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $house->title) }}" 
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="price" id="price" value="{{ old('price', $house->price) }}" 
                        ...
                        <div>
                            ...
                            <select name="type" id="type" 
                                ...
                                <option value="rent" {{ old('type', $house->type) === 'rent' ? 'selected' : '' }}>For Rent</option>
                                <option value="sale" {{ old('type', $house->type) === 'sale' ? 'selected' : '' }}>For Sale</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            @if($house->image_url)
                                <div class="mt-2 mb-4">
                                    <img src="{{ asset($house->image_url) }}" alt="{{ $house->title }}" class="h-32 w-auto object-cover rounded-md">
                                </div>
                            @endif
                        ...
                        <div class="flex justify-end">
                            <a href="{{ route('houses.show', $house) }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancel
                            </a>
